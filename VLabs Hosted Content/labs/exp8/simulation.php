...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
					...
					<div id="top_div" >
					<div id="top_left_div" style="float:left; font-size:20px"><br><br>
					<p>&rarr; Set the values of membership function .</p>
                            <p>&rarr; Set the scalar input value.</p>
							<p>&rarr; Start the simulation.</p>
                        </div>
    ...
    <tbody>
      <tr>
        <td>Cool</td>
        <td width="200"><div id="cool_start_slider"></div>
		<span class="cool_start_value">30</span>		
		</td>
        <td width="200"><div id="cool_end_slider"></div>
		<span class="cool_end_value">70</span></td>
	  </tr>
      <tr>
        <td>Warm</td>
        <td><div id="warm_start_slider"></div>
		<span class="warm_start_value">50</span></td>
        <td><div id="warm_end_slider"></div>
		<span class="warm_end_value">90</span></td>
      </tr>
      <tr>
        <td>Hot</td>
        <td><div id="hot_start_slider"></div>
		<span class="hot_start_value">80</span></td>
        <td><div id="hot_end_slider"></div>
		<span class="hot_end_value">120</span></td>
      </tr>
	  <tr>
        <td>Scallar Input</td>
        <td><div id="scallar_slider"></div>
		<span class="scallar_value">55</span></td>
        <td> <button  id="main_button" type="button" class="btn btn-primary" onclick="startSimulation1()">Start The Simulation</button></td>
      </tr>
    </tbody>
  </table>
							</div>
					...
					<svg id="graph_svg" width="700" height="500" style="">
						...
						x1="20" y1="400" x2="700" y2="400" style=""/>
						<line id="y_axis" class="axis" stroke="#000" stroke-width="2"
						x1="20" y1="400" x2="20" y2="0" style=""/>
						<text font-size="20" x="20" y="420">0</text>
						<text font-size="20" x="600" y="420">temprature</text>
						<text font-size="20" x="50" y="20">Degree Of Truth</text>
						
						<text font-size="15" x="60" y="405"> | </text>
						<text font-size="15" x="100" y="405">|</text>
						<text font-size="15" x="140" y="405">|</text>
						<text font-size="15" x="180" y="405">|</text>
						<text font-size="15" x="220" y="405">|</text>
						<text font-size="15" x="260" y="405">|</text>
						<text font-size="15" x="300" y="405">|</text>
						<text font-size="15" x="340" y="405">|</text>
						<text font-size="15" x="380" y="405">|</text>
						<text font-size="15" x="420" y="405">|</text>
						<text font-size="15" x="460" y="405">|</text>
						<text font-size="15" x="500" y="405">|</text>
						
						<text font-size="17" x="5" y="200">1</text>
						<text font-size="30" x="15" y="200">-</text>
						
						<text font-size="17" x="60" y="430">10</text>
						<text font-size="17" x="100" y="430">20</text>
						<text font-size="17" x="140" y="430">30</text>
						<text font-size="17" x="180" y="430">40</text>
						<text font-size="17" x="220" y="430">50</text>
						<text font-size="17" x="260" y="430">60</text>
						<text font-size="17" x="300" y="430">70</text>
						<text font-size="17" x="340" y="430">80</text>
						<text font-size="17" x="380" y="430">90</text>
						<text font-size="17" x="420" y="430">100</text>
						<text font-size="17" x="460" y="430">110</text>
						<text font-size="17" x="500" y="430">120</text>
						
						<line id="cool_line1" class="line" stroke="#f00" stroke-width="2" 
						x1="140" y1="400" x2="220" y2="200" style=""/>
						<line id="cool_line2" class="line" stroke="#f00" stroke-width="2" 
						x1="220" y1="200" x2="300" y2="400" style=""/>
						
						<line id="warm_line1" class="line" stroke="#0f0" stroke-width="2" 
						x1="220" y1="400" x2="300" y2="200" style=""/>
						<line id="warm_line2" class="line" stroke="#0f0" stroke-width="2" 
						x1="300" y1="200" x2="380" y2="400" style=""/>
						
						<line id="hot_line1" class="line" stroke="#00f" stroke-width="2" 
						x1="340" y1="400" x2="420" y2="200" style=""/>
						<line id="hot_line2" class="line" stroke="#00f" stroke-width="2" 
						x1="420" y1="200" x2="500" y2="400" style=""/>
