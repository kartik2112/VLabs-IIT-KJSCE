        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <input type="radio" class="optradio4" name="q4" value="2"> B.  It can survive the failure of some nodes<br>
                        <input type="radio" class="optradio4" name="q4" value="3"> C.  It has inherent parallelism<br>
                        <input type="radio" class="optradio4" name="q4" value="4"> D.  It can handle noise<br>
                        <br />
