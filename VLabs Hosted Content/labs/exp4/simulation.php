                ...
                <section class="content">
                    ...
                    <div id="hebbLRMainOuterDiv" style="display: none;">
                            ...
                            <svg id="hebbLR_svg" width="700" height="400" style="float: left;clear:left;">
                                        ...
                                        <!--y(x) related texts-->
                                        <text font-size="20" x="665" y="50" style="stroke: #3366ff;stroke-width: 1px;">O1</text>
                                        <text class="changingTextStyle hebbLR_outputO1" font-size="20" x="670" y="80" style="stroke: #3366ff;"></text>
                                
                                        <text font-size="20" x="665" y="200" style="stroke: #ff0000;stroke-width: 1px;">O2</text>
                                        <text class="changingTextStyle hebbLR_outputO2" font-size="20" x="670" y="230" style="stroke: #ff0000;"></text>
                                
                                        <text font-size="20" x="665" y="350" style="stroke: #009933;stroke-width: 1px;">O3</text>
                                        <text class="changingTextStyle hebbLR_outputO3" font-size="20" x="670" y="380" style="stroke: #009933;"></text>
                            </svg>
