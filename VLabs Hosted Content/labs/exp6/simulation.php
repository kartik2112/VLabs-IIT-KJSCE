                ...
                <section class="content">
                    ...
                    <div id="corrLRMainOuterDiv">
                            ...
                            <svg id="corrLR_svg" width="700" height="400" style="float: left;clear:left;">
                                        ...
                                        <text class="changingTextStyle corrLRX_inputX1" font-size="15" x="45" y="57" style="stroke: #ff0000;stroke-width: 1px;"></text>
                                        <text font-size="15" x="5" y="210">X2</text>
                                        <text class="changingTextStyle corrLRX_inputX2" font-size="15" x="45" y="207" style="stroke: #ff0000;stroke-width: 1px;"></text>
