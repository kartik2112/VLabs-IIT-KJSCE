                        ...
                        <div id="expln">
                            ...
                            <ol>
                                ...
                                <li>The actual output vector as obtained from the above calculations and the desired output vector are shown side by side for comparison. 
                                    <b>Correlation Learning Rule being supervised</b>, this desired output vector will actually be used in the learning process.</li>
                                <li>The correlation learning rule whose formula is shown is applied using these vectors.</li>
