        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="radio">
                        <label><input type="radio" class="optradio1" id="Q11"><table class="table-condensed truthTable" style="text-align: center;">
                    ...
                    <div class="radio">
                        <label><input type="radio" class="optradio1" id="Q12"><table class="table-condensed truthTable" style="text-align: center;">
                                    <tr><th>I/P</th><th>O/P</th></tr>
                    ...
                    <div class="radio">
                        <label><input type="radio" class="optradio1" id="Q13"><table class="table-condensed truthTable" style="text-align: center;">
                                    <tr><th>I/P</th><th>O/P</th></tr>
                                    <tr><td>0</td><td>0</td></tr>
                                    <tr><td>1</td><td>0</td></tr>
                                    </table></label>
                    ...
                    <div class="radio">
                        <label><input type="radio" class="optradio1" id="Q14"><table class="table-condensed truthTable" style="text-align: center;">
                                    <tr><th>I/P</th><th>O/P</th></tr>
                                    <tr><td>0</td><td>1</td></tr>
                                    <tr><td>1</td><td>1</td></tr>
                                    </table></label>
                    </div>
                    <p id="optradio1Ans" style="display:none; font-size:20px;"> Ans is B</p>

                    <h3>2. Two inputs to AND Gate are 0 and 1 respectively. Which of the following will be the output of the AND Gate?</h3>
                    <div class="radio">
                        <label><input type="radio" class="optradio2" id="Q21"><table class="table-condensed truthTable" style="text-align: center;">
                                    0
                                    </table></label>
                    </div>
                    <div class="radio">
                    ...
                    <div class="radio">
                        <label><input type="radio" class="optradio3" id="Q31"><table class="table-condensed truthTable" style="text-align: center;">
                    ...
                    <div class="radio">
                     ...
                     <p id="optradio3Ans" style="display:none; font-size:20px;"> Ans is D</p>
